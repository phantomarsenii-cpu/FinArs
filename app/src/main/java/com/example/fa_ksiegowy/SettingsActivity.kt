...
class SettingsActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Update: wiersz "Wyglad" z makiety — aplikacja ma dzis wylacznie ciemny
        // motyw (brak infrastruktury do przelaczania), wiec zamiast udawac dzialajacy
        // przelacznik pokazujemy uczciwy komunikat zamiast cichego braku reakcji.
        findViewById<View>(R.id.btn_menu_appearance).setOnClickListener {
            AlertDialog.Builder(this)
                .setTitle(getString(R.string.settings_menu_appearance))
                .setMessage(getString(R.string.appearance_dark_only_message))
