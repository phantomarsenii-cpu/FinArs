...
echo "=== Update 56: pelny redesign glownego ekranu (Start) wg makiety ==="
echo "Co sie zmienia:"
echo " 1) Naglowek: mala ikona + FinArs + dzwonek (zamiast duzego logo na srodku)"
echo " 2) Karta Bilans: procentowy trend vs poprzedni miesiac + 3 kolumny"
echo "    Przychod / Wydatek / Podatek zamiast listy wierszy"
echo " 3) Karta Limity: ikony, procent po prawej stronie kazdego paska, link Edytuj"
echo "    (otwiera ustawienia podatkowe)"
echo " 4) Nowa karta Podsumowanie miesiaca z wykresem (recykluje istniejacy"
echo "    MonthlyBarChartView, dane dzielone na 5 przedzialow dni w miesiacu)"
echo " 5) Nowa karta Ostatnie transakcje - 5 najnowszych operacji, link"
echo "    Zobacz wszystkie do pelnej historii"
echo " 6) Wszystkie dotychczasowe funkcje/logika (podatki, limity, Pro, reklamy,"
echo "    ukryty gest developera) dzialaja bez zmian - zmienil sie tylko wyglad"
echo ""
...
if grep -q "tv_balance_trend" app/src/main/res/layout/activity_mine.xml 2>/dev/null; then
    echo "!!! Wyglada na to, ze update_project-56 zostal juz zastosowany (tv_balance_trend juz istnieje)"
    exit 1
fi

BACKUP_DIR=".update56_backup_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$BACKUP_DIR"
if [ -f "app/src/main/res/values/colors.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/values/colors.xml")"; cp "app/src/main/res/values/colors.xml" "$BACKUP_DIR/app/src/main/res/values/colors.xml"; fi
if [ -f "app/src/main/res/values/strings.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/values/strings.xml")"; cp "app/src/main/res/values/strings.xml" "$BACKUP_DIR/app/src/main/res/values/strings.xml"; fi
if [ -f "app/src/main/res/values-pl/strings.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/values-pl/strings.xml")"; cp "app/src/main/res/values-pl/strings.xml" "$BACKUP_DIR/app/src/main/res/values-pl/strings.xml"; fi
if [ -f "app/src/main/res/values-ru/strings.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/values-ru/strings.xml")"; cp "app/src/main/res/values-ru/strings.xml" "$BACKUP_DIR/app/src/main/res/values-ru/strings.xml"; fi
if [ -f "app/src/main/res/layout/activity_mine.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/layout/activity_mine.xml")"; cp "app/src/main/res/layout/activity_mine.xml" "$BACKUP_DIR/app/src/main/res/layout/activity_mine.xml"; fi
if [ -f "app/src/main/res/drawable/card_bg_balance.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/card_bg_balance.xml")"; cp "app/src/main/res/drawable/card_bg_balance.xml" "$BACKUP_DIR/app/src/main/res/drawable/card_bg_balance.xml"; fi
if [ -f "app/src/main/res/drawable/icon_badge_blue_bg.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/icon_badge_blue_bg.xml")"; cp "app/src/main/res/drawable/icon_badge_blue_bg.xml" "$BACKUP_DIR/app/src/main/res/drawable/icon_badge_blue_bg.xml"; fi
if [ -f "app/src/main/res/drawable/icon_badge_green_bg.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/icon_badge_green_bg.xml")"; cp "app/src/main/res/drawable/icon_badge_green_bg.xml" "$BACKUP_DIR/app/src/main/res/drawable/icon_badge_green_bg.xml"; fi
if [ -f "app/src/main/res/drawable/icon_badge_red_bg.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/icon_badge_red_bg.xml")"; cp "app/src/main/res/drawable/icon_badge_red_bg.xml" "$BACKUP_DIR/app/src/main/res/drawable/icon_badge_red_bg.xml"; fi
if [ -f "app/src/main/res/drawable/legend_dot.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/legend_dot.xml")"; cp "app/src/main/res/drawable/legend_dot.xml" "$BACKUP_DIR/app/src/main/res/drawable/legend_dot.xml"; fi
if [ -f "app/src/main/res/drawable/ic_bell.xml" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/res/drawable/ic_bell.xml")"; cp "app/src/main/res/drawable/ic_bell.xml" "$BACKUP_DIR/app/src/main/res/drawable/ic_bell.xml"; fi
if [ -f "app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt" ]; then mkdir -p "$BACKUP_DIR/$(dirname "app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt")"; cp "app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt" "$BACKUP_DIR/app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt"; fi
echo "--- Backup istniejacych plikow zapisany w $BACKUP_DIR ---"

mkdir -p "app/src/main/res/values"
cat > "app/src/main/res/values/colors.xml" << 'EOF_COLORS_XML'
...
<resources>
    ...
    <color name="badge_bg_blue">#1E2A4D</color>
    <color name="badge_bg_green">#173327</color>
    <color name="badge_bg_red">#3A1414</color>
    <color name="badge_percent_blue">#60A5FA</color>
    <color name="badge_percent_green">#34D399</color>
    <color name="badge_percent_red">#F87171</color>
    <color name="card_bg_balance">#141E42</color>
    <color name="card_border_balance">#2B3868</color>
</resources>
EOF_COLORS_XML
echo "Napisano: app/src/main/res/values/colors.xml"

mkdir -p "app/src/main/res/values"
cat > "app/src/main/res/values/strings.xml" << 'EOF_STRINGS_EN_XML'
<?xml version="1.0" encoding="utf-8"?>
<resources>
...
EOF_STRINGS_EN_XML
echo "Napisano: app/src/main/res/values/strings.xml"

mkdir -p "app/src/main/res/values-pl"
cat > "app/src/main/res/values-pl/strings.xml" << 'EOF_STRINGS_PL_XML'
<?xml version="1.0" encoding="utf-8"?>
<resources>
    <string name="app_name">FinArs</string>
    <string name="app_subtitle">FinArs</string>
...
EOF_STRINGS_PL_XML
echo "Napisano: app/src/main/res/values-pl/strings.xml"

mkdir -p "app/src/main/res/values-ru"
cat > "app/src/main/res/values-ru/strings.xml" << 'EOF_STRINGS_RU_XML'
<?xml version="1.0" encoding="utf-8"?>
<resources>
    <string name="app_name">FinArs</string>
    <string name="app_subtitle">FinArs</string>
...
EOF_STRINGS_RU_XML
echo "Napisano: app/src/main/res/values-ru/strings.xml"

mkdir -p "app/src/main/res/layout"
cat > "app/src/main/res/layout/activity_mine.xml" << 'EOF_ACTIVITY_MINE_XML'
<?xml version="1.0" encoding="utf-8"?>
        ...
        <LinearLayout
            ...
            <LinearLayout
                ...
                <TextView
                    ...
                    android:text="@string/balance_vs_prev_month"
                    android:textColor="@color/text_secondary"
                    android:textSize="12sp"/>
        ...
        <LinearLayout
            ...
            <LinearLayout android:id="@+id/layout_limit_monthly" android:layout_width="match_parent" android:layout_height="wrap_content"
                ...
                <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                    ...
                    <TextView android:id="@+id/tv_limit_monthly_label" android:layout_width="0dp" android:layout_weight="1" android:layout_height="wrap_content"
                        android:layout_marginStart="10dp"
            ...
            <LinearLayout android:id="@+id/layout_limit_bracket" android:layout_width="match_parent" android:layout_height="wrap_content"
                ...
                <LinearLayout android:layout_width="match_parent" android:layout_height="wrap_content"
                    ...
                    <TextView android:id="@+id/tv_limit_bracket_label" android:layout_width="0dp" android:layout_weight="1" android:layout_height="wrap_content"
                        android:layout_marginStart="10dp"
                        android:textColor="@color/text_primary" android:textSize="13sp"/>
...
EOF_ACTIVITY_MINE_XML
echo "Napisano: app/src/main/res/layout/activity_mine.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/card_bg_balance.xml" << 'EOF_CARD_BG_BALANCE_XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="rectangle">
    <corners android:radius="20dp" />
    <solid android:color="@color/card_bg_balance" />
    <stroke android:width="1dp" android:color="@color/card_border_balance" />
</shape>
EOF_CARD_BG_BALANCE_XML
echo "Napisano: app/src/main/res/drawable/card_bg_balance.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/icon_badge_blue_bg.xml" << 'EOF_ICON_BADGE_BLUE_XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="rectangle">
    <corners android:radius="12dp" />
    <solid android:color="@color/badge_bg_blue" />
</shape>
EOF_ICON_BADGE_BLUE_XML
echo "Napisano: app/src/main/res/drawable/icon_badge_blue_bg.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/icon_badge_green_bg.xml" << 'EOF_ICON_BADGE_GREEN_XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="rectangle">
    <corners android:radius="12dp" />
    <solid android:color="@color/badge_bg_green" />
</shape>
EOF_ICON_BADGE_GREEN_XML
echo "Napisano: app/src/main/res/drawable/icon_badge_green_bg.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/icon_badge_red_bg.xml" << 'EOF_ICON_BADGE_RED_XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="rectangle">
    <corners android:radius="12dp" />
    <solid android:color="@color/badge_bg_red" />
</shape>
EOF_ICON_BADGE_RED_XML
echo "Napisano: app/src/main/res/drawable/icon_badge_red_bg.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/legend_dot.xml" << 'EOF_LEGEND_DOT_XML'
<?xml version="1.0" encoding="utf-8"?>
<shape xmlns:android="http://schemas.android.com/apk/res/android" android:shape="oval">
    <solid android:color="@color/income_green" />
</shape>
EOF_LEGEND_DOT_XML
echo "Napisano: app/src/main/res/drawable/legend_dot.xml"

mkdir -p "app/src/main/res/drawable"
cat > "app/src/main/res/drawable/ic_bell.xml" << 'EOF_IC_BELL_XML'
<?xml version="1.0" encoding="utf-8"?>
<vector xmlns:android="http://schemas.android.com/apk/res/android"
    android:width="24dp" android:height="24dp" android:viewportWidth="24" android:viewportHeight="24">
    <path android:fillColor="#FFFFFF" android:pathData="M12,22c1.1,0 2,-0.9 2,-2h-4C10,21.1 10.9,22 12,22zM18,16v-5c0,-3.07 -1.64,-5.64 -4.5,-6.32V4c0,-0.83 -0.67,-1.5 -1.5,-1.5s-1.5,0.67 -1.5,1.5v0.68C7.63,5.36 6,7.92 6,11v5l-2,2v1h16v-1l-2,-2z"/>
</vector>
EOF_IC_BELL_XML
echo "Napisano: app/src/main/res/drawable/ic_bell.xml"

mkdir -p "app/src/main/java/com/example/fa_ksiegowy"
cat > "app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt" << 'EOF_MINE_ACTIVITY_KT'
...
class MineActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Karta "Limity" -> edycja formy dzialalnosci/stawek w ustawieniach podatkowych.
...
EOF_MINE_ACTIVITY_KT
echo "Napisano: app/src/main/java/com/example/fa_ksiegowy/MineActivity.kt"

echo ""
echo "Gotowe. Nastepny krok (Termux):"
echo "  git add -A"
echo '  git commit -m "update 56: home screen redesign to match mockup"'
